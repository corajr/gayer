/* translated from Instascan module in npm */
type camera;
type constraints;

[@bs.send] external id : camera => string = "";
[@bs.send] external name : camera => string = "";

let startCamera: constraints => Js.Promise.t(option(camera)) = [%bs.raw
  {|
/*
