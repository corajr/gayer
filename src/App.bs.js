...
var defaultState_012 = /* compressor : record */[/* contents */undefined];

var defaultState_013 = /* merger : record */[/* contents */undefined];

var defaultState_014 = /* analysisCanvasRef : record */[/* contents */undefined];

var defaultState_015 = /* midiCanvasRef : record */[/* contents */undefined];

var defaultState_017 = /* loadedImages : record */[/* contents */Belt_MapString.empty];

var defaultState_018 = /* loadedAudio : record */[/* contents */Belt_MapString.empty];

var defaultState_019 = /* canvasRef : record */[/* contents */undefined];

var defaultState_020 = /* scaleCanvas */480.0 / Presets$Gayer.defaultSize;

var defaultState_022 = /* tickFunctions : record */[/* contents : [] */0];
...
function setAnalysisCanvasRef(theRef, param) {
  param[/* state */1][/* analysisCanvasRef */14][0] = (theRef == null) ? undefined : Js_primitive.some(theRef);
  return /* () */0;
}
...
function setLayerRef(audioCtx, param, param$1) {
  ...
  if (typeof match === "number") {
    if (theRef == null) {
      ...
      state[/* midiCanvasRef */15][0] = maybeRef;
      return /* () */0;
    }
  } else {
    switch (match.tag | 0) {
      ...
      case 3 : 
          if (theRef == null) {
            ...
            state[/* loadedImages */17][0] = Belt_MapString.set(state[/* loadedImages */17][0], match[0], theRef);
            return /* () */0;
          }
      case 4 : 
          if (theRef == null) {
            ...
            var url = match[0];
            state[/* loadedImages */17][0] = Belt_MapString.set(state[/* loadedImages */17][0], url, theRef);
            ...
            if (readyState >= 3) {
              ...
              if (match$2 !== undefined) {
                ...
                state[/* loadedAudio */18][0] = Belt_MapString.set(state[/* loadedAudio */18][0], url, mediaElementSource);
                return /* () */0;
              }
            } else {
              return 0;
      ...
      case 5 : 
          if (theRef == null) {
            ...
            var source = match[0];
            state[/* analysisCanvasRef */14][0] = maybeRef;
            if (typeof source === "number" || source.tag) {
              return /* () */0;
            } else {
              var url$1 = source[0];
              if (Belt_MapString.has(state[/* loadedAudio */18][0], url$1)) {
                return 0;
              } else {
...
function connectInputs(state) {
  var match = state[/* filterBanks */11];
  var match$1 = state[/* filterInput */5];
  var match$2 = state[/* merger */13][0];
  if (match !== undefined) {
    var match$3 = match;
    if (match$3.tag) {
      if (match$1 !== undefined) {
...
function drawLayer(ctx, width, height, state, layer) {
  ...
  var exit = 0;
  if (typeof match === "number") {
    var match$1 = state[/* midiCanvasRef */15][0];
    if (match$1 !== undefined) {
    ...
    switch (match.tag | 0) {
      ...
      case 1 : 
          ...
          return undefined;
      case 2 : 
          var match$2 = state[/* cameraInput */10][0];
      ...
      case 4 : 
          ...
          break;
      case 5 : 
          var match$4 = state[/* analysisCanvasRef */14][0];
  ...
  if (exit === 1) {
    var match$6 = Belt_MapString.get(state[/* loadedImages */17][0], match[0]);
    if (match$6 !== undefined) {
      ctx.drawImage(Js_primitive.valFromOption(match$6), 0, 0, width, height);
    }
    return undefined;
  }
...
function getAnalysisInput(audioCtx, state, audioInput) {
  if (typeof audioInput === "number") {
    ...
    return /* tuple */[
            audioCtx,
            Belt_MapString.get(state[/* loadedAudio */18][0], audioInput[0])
          ];
  }
}
...
function make($staropt$star, $staropt$star$1, $staropt$star$2, _) {
  ...
  return /* record */[
          ...
          /* didMount */(function (self) {
              ...
              self[/* state */1][/* tickFunctions */22][0] = /* :: */[
                sendTickFn,
                self[/* state */1][/* tickFunctions */22][0]
              ];
          ...
          /* didUpdate */(function (param) {
              ...
              if (Caml_obj.caml_notequal(oldSelf[/* state */1][/* filterInput */5], newSelf[/* state */1][/* filterInput */5]) || Caml_obj.caml_notequal(oldSelf[/* state */1][/* filterBanks */11], newSelf[/* state */1][/* filterBanks */11])) {
              ...
              if (oldSelf[/* state */1][/* params */6][/* q */8] !== newSelf[/* state */1][/* params */6][/* q */8] || oldSelf[/* state */1][/* params */6][/* transpose */9] !== newSelf[/* state */1][/* params */6][/* transpose */9]) {
                ...
                var match$2 = newSelf[/* state */1][/* filterBanks */11];
                if (match$2 !== undefined) {
                  var match$3 = match$2;
                  if (match$3.tag) {
                    updateFn(match$3[0]);
              ...
              if (oldSelf[/* state */1][/* params */6][/* millisPerTick */4] !== newSelf[/* state */1][/* params */6][/* millisPerTick */4]) {
                Timing$Gayer.setTimer(newSelf[/* state */1][/* timerId */23], (function () {
                        return List.iter((function (f) {
                                      return Curry._1(f, /* () */0);
                                    }), newSelf[/* state */1][/* tickFunctions */22][0]);
          ...
          /* reducer */(function (action, state) {
              if (typeof action === "number") {
                switch (action) {
                  ...
                  case 1 : 
                      return /* SideEffects */Block.__(1, [(function (self) {
                                    ...
                                    return maybeUpdateCanvas(self[/* state */1][/* canvasRef */19], (function (canvas) {
                                                  ...
                                                  var match = self[/* state */1][/* filterBanks */11];
                                                  if (match !== undefined) {
                                                    var match$1 = match;
                                                    if (match$1.tag) {
                                                      ...
                                                      if (filterValues.tag) {
                                                        ...
                                                        return updateBank(filterValues[1], filterBankR);
                                                      } else {
                                                      ...
                                                      return updateBank(filterValues[0], match$1[0]);
                                                    }
                                                  } else {
                                                    return /* () */0;
                                                  }
                  ...
                  case 3 : 
                      return /* SideEffects */Block.__(1, [(function (self) {
                                    var match = state[/* canvasRef */19][0];
                                    if (match !== undefined) {
                ...
                switch (action.tag | 0) {
                  ...
                  case 5 : 
                      ...
                      return /* UpdateWithSideEffects */Block.__(2, [
                                (newrecord$6[/* filterBanks */11] = action[0], newrecord$6),
                                (function (self) {
                                    return connectInputs(self[/* state */1]);
                                  })
                              ]);
