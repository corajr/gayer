...
function setCanvasRef(theRef, param) {
  ...
  state[/* canvasRef */23][0] = maybeRef;
  if (theRef == null) {
    return /* () */0;
  } else {
    state[/* layerRefs */20][0] = Belt_MapString.set(state[/* layerRefs */20][0], "root", theRef);
    state[/* drawContext */24][/* maybeCtxRef */0][0] = Js_primitive.some(theRef.getContext("2d"));
    return /* () */0;
  }
}
...
function setLayerRef(param, param$1) {
  ...
  if (!(theRef == null)) {
    state[/* layerRefs */20][0] = Belt_MapString.set(state[/* layerRefs */20][0], layerKey, theRef);
  }
  var match = layer[/* content */0];
  if (typeof match === "number" && !(match !== 1 || (theRef == null))) {
    var match$1 = state[/* mediaStream */10];
    if (match$1 !== undefined) {
      var video = Video$Gayer.attachVideoStream(theRef, Js_primitive.valFromOption(match$1));
      state[/* cameraInput */13][0] = Js_primitive.some(video);
      state[/* layerRefs */20][0] = Belt_MapString.set(state[/* layerRefs */20][0], "webcam", theRef);
      return /* () */0;
    } else {
      return /* () */0;
    }
...
function connectInputs(state) {
  var match = state[/* filterBanks */15];
  var match$1 = state[/* filterInput */6];
  var match$2 = state[/* merger */18][0];
  if (match !== undefined) {
    var match$3 = match;
    if (match$3.tag) {
      if (match$1 !== undefined) {
...
function getReadAndWritePos(f, param) {
  var state = param[/* state */1];
  var width = state[/* params */7][/* width */0];
  var xToRead = Canvas$Gayer.wrapCoord(state[/* readPos */3][0] + state[/* params */7][/* readPosOffset */4] | 0, 0, width);
  var xToWrite = Canvas$Gayer.wrapCoord(state[/* writePos */4][0] + state[/* params */7][/* writePosOffset */5] | 0, 0, width);
...
function drawLayer(ctx, width, height, state, layer) {
  ...
  var layerKey = Layer$Gayer.getLayerKey(layer);
  if (Caml_int32.mod_(state[/* tickCounter */28][0], layer[/* tickPeriod */7]) === layer[/* tickPhase */8]) {
    var match = Belt_MapString.get(state[/* tickFunctions */27][0], layerKey);
    if (match !== undefined) {
      Curry._1(match, state[/* tickCounter */28][0]);
    }
    
  }
  var maybeLayerRef = Belt_MapString.get(state[/* layerRefs */20][0], layerKey);
  ...
  if (typeof match$1 === "number") {
    switch (match$1) {
      case 1 : 
          var match$2 = state[/* cameraInput */13][0];
          if (match$2 !== undefined) {
    ...
    switch (match$1.tag | 0) {
      case 0 : 
          ...
          break;
      case 2 : 
          DrawCommand$Gayer.drawCommands(state[/* drawContext */24], match$1[0]);
          break;
      case 4 : 
          exit = 1;
          break;
      case 7 : 
          if (maybeLayerRef !== undefined) {
            ...
            if (typeof analysisSize === "number") {
              var x = Canvas$Gayer.wrapCoord(state[/* writePos */4][0] + state[/* params */7][/* writePosOffset */5] | 0, 0, width);
              ...
              switch (analysisSize.tag | 0) {
                ...
                case 2 : 
                    ...
                    var analysisX = DrawCommand$Gayer.getLength(state[/* drawContext */24], match$3[/* x */0]);
                    var analysisY = DrawCommand$Gayer.getLength(state[/* drawContext */24], match$3[/* y */1]);
      ...
      case 14 : 
          ...
          ImageDataUtil$Gayer.updateFilterValuesFromImageData(slice, readerType, state[/* currentFilterValues */19]);
          if (readerType) {
            var tmp;
            switch (readerType[0]) {
              case 0 : 
  ...
  setTimeout((function () {
          var match = Belt_MapString.get(state[/* tickFunctions */27][0], layerKey + "preview");
          if (match !== undefined) {
...
function drawCanvas(canvasElement, width, height, state) {
  ...
  if (state[/* params */7][/* shouldClear */13]) {
  ...
  if (typeof audioInput === "number") {
    switch (audioInput) {
      case 0 : 
          return /* tuple */[
                  state[/* audioCtx */2][0],
                  Belt_Option.map(state[/* audioCtx */2][0], Audio$Gayer.pinkNoise)
                ];
      case 1 : 
          return /* tuple */[
                  state[/* audioCtx */2][0],
                  Belt_Option.map(state[/* audioCtx */2][0], Audio$Gayer.whiteNoise)
                ];
      case 2 : 
          return /* tuple */[
                  state[/* audioCtx */2][0],
    ...
    switch (audioInput.tag | 0) {
      ...
      case 1 : 
          return /* tuple */[
                  state[/* audioCtx */2][0],
                  Belt_MapString.get(state[/* loadedAudio */22][0], audioInput[0])
                ];
      case 2 : 
          var match = state[/* oscillatorBank */14][0];
          return /* tuple */[
                  state[/* audioCtx */2][0],
...
function generateNewFilterBanks(param) {
  var send = param[/* send */3];
  var state = param[/* state */1];
  var match = state[/* audioCtx */2][0];
  if (match !== undefined) {
    var audioCtx = Js_primitive.valFromOption(match);
    console.log("regenerating filter banks (costly!)");
    var pixelsPerSemitone = Canvas$Gayer.binsPerSemitone(state[/* params */7][/* height */1]);
    state[/* freqFuncParams */5][0] = /* tuple */[
      pixelsPerSemitone,
      16
    ];
    var freqFunc = Audio$Gayer.yToFrequency(pixelsPerSemitone, 16 + state[/* params */7][/* transpose */11] | 0, state[/* params */7][/* height */1]);
    if (state[/* params */7][/* stereo */12]) {
      var filterBankL = Audio$Gayer.makeFilterBank(audioCtx, state[/* params */7][/* height */1], state[/* params */7][/* q */10], freqFunc);
      var filterBankR = Audio$Gayer.makeFilterBank(audioCtx, state[/* params */7][/* height */1], state[/* params */7][/* q */10], freqFunc);
      state[/* currentFilterValues */19][0] = /* Stereo */Block.__(1, [
          Caml_array.caml_make_vect(state[/* params */7][/* height */1], 0.0),
          Caml_array.caml_make_vect(state[/* params */7][/* height */1], 0.0)
        ]);
      ...
      var filterBank = Audio$Gayer.makeFilterBank(audioCtx, state[/* params */7][/* height */1], state[/* params */7][/* q */10], freqFunc);
      state[/* currentFilterValues */19][0] = /* Mono */Block.__(0, [Caml_array.caml_make_vect(state[/* params */7][/* height */1], 0.0)]);
...
function updateBank(state, values, filterBank) {
  return Audio$Gayer.updateFilterBank(state[/* params */7][/* inputGain */8], state[/* params */7][/* outputGain */9], filterBank, values);
}
...
function updateFilterBanks(param) {
  ...
  if (match !== undefined) {
    ...
    if (match$1.tag) {
      ...
      var match$2 = state[/* currentFilterValues */19][0];
      if (match$2 !== undefined) {
        var match$3 = match$2;
        if (match$3.tag) {
      ...
      var match$4 = state[/* currentFilterValues */19][0];
...
function saveTick(param, onUnmount, key, tickFn) {
  var state = param[/* state */1];
  state[/* tickFunctions */27][0] = Belt_MapString.set(state[/* tickFunctions */27][0], key, tickFn);
  return Curry._1(onUnmount, (function () {
                state[/* tickFunctions */27][0] = Belt_MapString.remove(state[/* tickFunctions */27][0], key);
                return /* () */0;
              }));
}
...
function make() {
  return /* record */[
          ...
          /* didMount */(function (self) {
              ...
              Timing$Gayer.setTimer(self[/* state */1][/* timerId */29], (function () {
                      return Curry._1(self[/* send */3], /* Tick */2);
                    }), self[/* state */1][/* params */7][/* millisPerTick */6]);
              Curry._1(self[/* onUnmount */4], (function () {
                      return Timing$Gayer.maybeClearTimer(self[/* state */1][/* timerId */29]);
                    }));
              var watcherID = ReasonReact.Router[/* watchUrl */1]((function (url) {
                      ...
                      if (exit === 1) {
                        self[/* state */1][/* startingIndexRef */26][0] = i;
                        i;
                      }
          ...
          /* didUpdate */(function (param) {
              ...
              if (Caml_obj.caml_notequal(oldSelf[/* state */1][/* filterInput */6], newSelf[/* state */1][/* filterInput */6]) || Caml_obj.caml_notequal(oldSelf[/* state */1][/* filterBanks */15], newSelf[/* state */1][/* filterBanks */15])) {
                disconnectInputs(oldSelf[/* state */1]);
              }
              if (Caml_obj.caml_notequal(oldSelf[/* state */1][/* params */7][/* audioInputSetting */7], newSelf[/* state */1][/* params */7][/* audioInputSetting */7])) {
                var match = getAnalysisInput(newSelf[/* state */1], newSelf[/* state */1][/* params */7][/* audioInputSetting */7]);
                var audio = match[1];
                if (audio !== undefined) {
              ...
              var layersChanged = Caml_obj.caml_notequal(oldSelf[/* state */1][/* params */7][/* layers */14], newSelf[/* state */1][/* params */7][/* layers */14]);
              if (layersChanged || oldSelf[/* state */1][/* params */7][/* readPosOffset */4] !== newSelf[/* state */1][/* params */7][/* readPosOffset */4] || oldSelf[/* state */1][/* params */7][/* writePosOffset */5] !== newSelf[/* state */1][/* params */7][/* readPosOffset */4]) {
                newSelf[/* state */1][/* readPos */3][0] = 0;
                newSelf[/* state */1][/* writePos */4][0] = 0;
                newSelf[/* state */1][/* currentFilterValues */19][0] = /* Mono */Block.__(0, [Caml_array.caml_make_vect(newSelf[/* state */1][/* params */7][/* height */1], 0.0)]);
              }
              if (oldSelf[/* state */1][/* params */7][/* q */10] !== newSelf[/* state */1][/* params */7][/* q */10] || oldSelf[/* state */1][/* params */7][/* transpose */11] !== newSelf[/* state */1][/* params */7][/* transpose */11] || oldSelf[/* state */1][/* params */7][/* stereo */12] !== newSelf[/* state */1][/* params */7][/* stereo */12] || oldSelf[/* state */1][/* params */7][/* height */1] !== newSelf[/* state */1][/* params */7][/* height */1]) {
                generateNewFilterBanks(newSelf);
              }
              if (oldSelf[/* state */1][/* params */7][/* millisPerTick */6] !== newSelf[/* state */1][/* params */7][/* millisPerTick */6]) {
                Timing$Gayer.setTimer(newSelf[/* state */1][/* timerId */29], (function () {
                        return Curry._1(newSelf[/* send */3], /* Tick */2);
                      }), newSelf[/* state */1][/* params */7][/* millisPerTick */6]);
              }
              if (oldSelf[/* state */1][/* fullscreenCanvas */25] !== newSelf[/* state */1][/* fullscreenCanvas */25]) {
                if (newSelf[/* state */1][/* fullscreenCanvas */25]) {
                  var match$1 = newSelf[/* state */1][/* canvasRef */23][0];
                  if (match$1 !== undefined) {
          ...
          /* render */(function (self) {
              var match = self[/* state */1][/* score */8];
              var match$1 = self[/* state */1][/* audioCtx */2][0];
              var tmp;
              if (match$1 !== undefined) {
                var partial_arg = self[/* state */1];
                tmp = ReasonReact.element(undefined, undefined, MediaProvider$Gayer.make(sortLayers(self[/* state */1][/* params */7][/* layers */14]), self[/* state */1][/* params */7][/* width */0], self[/* state */1][/* params */7][/* height */1], (function (layer, theRef) {
                            return Curry._2(self[/* handle */0], setLayerRef, /* tuple */[
                                        layer,
                                        theRef
                                      ]);
                          }), (function (param) {
                            return getAnalysisInput(partial_arg, param);
                          }), self[/* state */1][/* drawContext */24], self[/* state */1][/* audioGraph */11], Js_primitive.valFromOption(match$1), self[/* state */1][/* layerRefs */20], self[/* state */1][/* currentFilterValues */19], (function (param, param$1, param$2) {
                            return saveTick(self, param, param$1, param$2);
                          }), self[/* state */1][/* readPos */3], self[/* state */1][/* writePos */4], self[/* state */1][/* params */7][/* millisPerTick */6], /* array */[]));
              } else {
                tmp = null;
              }
              return React.createElement("div", undefined, ReasonReact.element(undefined, undefined, MaterialUi_CssBaseline.make(/* array */[])), ReasonReact.element(undefined, undefined, MaterialUi_AppBar.make(undefined, undefined, /* Sticky */1070408009, undefined, undefined, undefined, undefined, undefined, /* array */[ReasonReact.element(undefined, undefined, MaterialUi_Toolbar.make(undefined, undefined, undefined, undefined, /* array */[
                                            ReasonReact.element(undefined, undefined, MaterialUi_IconButton.make(undefined, /* Inherit */-72987685, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, (function () {
                                                        return Curry._1(self[/* send */3], /* TogglePresetDrawer */3);
                                            ...
                                            match !== undefined ? React.createElement("div", {
                                                    onClick: (function () {
                                                        return Curry._1(self[/* send */3], /* InitAudio */1);
                                                      })
                                                  }, ReasonReact.element(undefined, undefined, ScoreControl$Gayer.make(match, self[/* state */1][/* audioCtx */2][0], /* array */[]))) : null
                                          ]))])), React.createElement("div", {
                              style: {
                                padding: "12px"
                              }
                            }, ReasonReact.element(undefined, undefined, Curry._2(SizedDrawer[/* make */6], (function (classes) {
                                        return ReasonReact.element(undefined, undefined, MaterialUi_Drawer.make(undefined, undefined, undefined, undefined, undefined, self[/* state */1][/* presetDrawerOpen */9], undefined, undefined, undefined, undefined, /* Temporary */-103274127, /* :: */[
                                      ...
                                      ReasonReact.element(undefined, undefined, MaterialUi_Grid.make(undefined, undefined, undefined, undefined, undefined, undefined, true, undefined, undefined, undefined, undefined, undefined, undefined, undefined, /* V6 */5, undefined, undefined, undefined, /* array */[ReasonReact.element(undefined, undefined, Params$Gayer.make(self[/* state */1][/* params */7], (function (layers) {
                                                          ...
                                                          }), self[/* state */1][/* layerRefs */20], (function (oldLayer, maybeNewLayer) {
                                                            ...
                                                            return saveTick(self, param, param$1, param$2);
                                                          }), self[/* state */1][/* savedImages */21], /* array */[]))])),
                                      ReasonReact.element(undefined, undefined, MaterialUi_Grid.make(undefined, undefined, undefined, undefined, undefined, undefined, true, undefined, undefined, undefined, undefined, undefined, undefined, undefined, /* V4 */3, undefined, undefined, undefined, /* array */[React.createElement("div", {
                                                    ...
                                                    }, tmp, React.createElement("canvas", {
                                                          ref: Curry._1(self[/* handle */0], setCanvasRef),
                                                          style: {
                                                            transform: "scale(" + ((400.0 / self[/* state */1][/* params */7][/* height */1]).toString() + ")"),
                                                            transformOrigin: "top left",
                                                            imageRendering: "crisp-edges"
                                                          },
                                                          height: self[/* state */1][/* params */7][/* height */1].toString(),
                                                          width: self[/* state */1][/* params */7][/* width */0].toString()
                                                        }))])),
                                      ReasonReact.element(undefined, undefined, MaterialUi_Grid.make(undefined, undefined, undefined, undefined, undefined, undefined, true, undefined, undefined, undefined, undefined, undefined, undefined, undefined, /* V2 */1, undefined, undefined, undefined, /* array */[
                                                ReasonReact.element(undefined, undefined, MaterialUi_Button.make(undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, /* Contained */-515484397, undefined, undefined, undefined, undefined, undefined, undefined, (function () {
                                                            return Curry._1(self[/* send */3], /* SaveImage */4);
                                                ...
                                                React.createElement("div", {
                                                      style: {
                                                        marginTop: "48px"
                                                          ...
                                                          }), Belt_MapString.toArray(self[/* state */1][/* savedImages */21])))
                                              ]))
                                    ]))));
            }),
              ...
              if (typeof action === "number") {
                switch (action) {
                  case 0 : 
                      return /* SideEffects */Block.__(1, [(function (self) {
                                    return maybeUpdateCanvas(self[/* state */1][/* canvasRef */23], (function (canvas) {
                                                  return clearCanvas(canvas, self[/* state */1][/* params */7][/* width */0], self[/* state */1][/* params */7][/* height */1]);
                                                }));
                                  })]);
                  case 1 : 
                      return /* SideEffects */Block.__(1, [(function (self) {
                                    var match = self[/* state */1][/* audioCtx */2][0];
                                    if (match !== undefined) {
                                      var audioCtx = Js_primitive.valFromOption(match);
                                      var compressor = Audio$Gayer.makeCompressor(audioCtx, Audio$Gayer.defaultCompressorValues);
                                      state[/* merger */18][0] = Belt_Option.map(state[/* audioCtx */2][0], (function (prim) {
                                              return prim.createChannelMerger();
                                            }));
                                      var masterGain = audioCtx.createGain();
                                      state[/* compressor */16][0] = Js_primitive.some(compressor);
                                      state[/* masterGain */17][0] = Js_primitive.some(masterGain);
                                      ...
                                      var match$1 = state[/* merger */18][0];
                                      if (match$1 !== undefined) {
                                        state[/* audioGraph */11][0] = AudioGraph$Gayer.updateConnections(AudioGraph$Gayer.addEdge(/* tuple */[
                                                  "masterGain",
                                                  "sink",
                                                  0,
                                                  0
                                                              ...
                                                              audioCtx.destination
                                                                  ...
                                                                  masterGain
                                                                      ...
                                                                      compressor
                                                                        ...
                                                                        ], state[/* audioGraph */11][0]))))))));
                                      }
                                      generateNewFilterBanks(self);
                                      var match$2 = UserMedia$Gayer.getAudioVisualStream(/* () */0);
                                      if (match$2 !== undefined) {
                                        Js_primitive.valFromOption(match$2).then((function (stream) {
                                      ...
                                      self[/* state */1][/* audioCtx */2][0] = Js_primitive.some(Curry._1(Audio$Gayer.makeDefaultAudioCtx, /* () */0));
                                      return Curry._1(self[/* send */3], /* InitAudio */1);
                                    }
                                  })]);
                  case 2 : 
                      return /* SideEffects */Block.__(1, [(function (self) {
                                    state[/* tickCounter */28][0] = state[/* tickCounter */28][0] + 1 | 0;
                                    state[/* readPos */3][0] = Canvas$Gayer.wrapCoord(state[/* readPos */3][0], state[/* params */7][/* readPosDelta */2], state[/* params */7][/* width */0]);
                                    state[/* writePos */4][0] = Canvas$Gayer.wrapCoord(state[/* writePos */4][0], state[/* params */7][/* writePosDelta */3], state[/* params */7][/* width */0]);
                                    return maybeUpdateCanvas(state[/* canvasRef */23], (function (canvas) {
                                                  drawCanvas(canvas, state[/* params */7][/* width */0], state[/* params */7][/* height */1], state);
                                                  updateFilterBanks(self);
                                                  var match = state[/* oscillatorBank */14][0];
                                                  if (match !== undefined) {
                                                    var match$1 = state[/* currentFilterValues */19][0];
                                                    if (match$1 !== undefined) {
                  ...
                  case 3 : 
                      ...
                      return /* Update */Block.__(0, [(newrecord[/* presetDrawerOpen */9] = !state[/* presetDrawerOpen */9], newrecord)]);
                  case 4 : 
                      return /* SideEffects */Block.__(1, [(function (self) {
                                    var match = state[/* canvasRef */23][0];
                                    if (match !== undefined) {
                  ...
                  case 5 : 
                      ...
                      return /* Update */Block.__(0, [(newrecord$1[/* fullscreenCanvas */25] = !state[/* fullscreenCanvas */25], newrecord$1)]);
                ...
                switch (action.tag | 0) {
                  case 0 : 
                      ...
                      return /* Update */Block.__(0, [(newrecord$2[/* savedImages */21] = Belt_MapString.set(state[/* savedImages */21], timestamp, action[0]), newrecord$2)]);
                  case 1 : 
                      var newrecord$3 = Caml_array.caml_array_dup(state);
                      return /* UpdateWithSideEffects */Block.__(2, [
                                (newrecord$3[/* filterInput */6] = action[0], newrecord$3),
                                (function (self) {
                  ...
                  case 2 : 
                      ...
                      return /* Update */Block.__(0, [(newrecord$4[/* micInput */12] = action[0], newrecord$4)]);
                  case 3 : 
                      var newrecord$5 = Caml_array.caml_array_dup(state);
                      return /* Update */Block.__(0, [(newrecord$5[/* mediaStream */10] = Js_primitive.some(action[0]), newrecord$5)]);
                  case 4 : 
                      var newrecord$6 = Caml_array.caml_array_dup(state);
                      return /* UpdateWithSideEffects */Block.__(2, [
                                (newrecord$6[/* filterBanks */15] = action[0], newrecord$6),
                                (function (self) {
                                    return connectInputs(self[/* state */1]);
                                  })
                              ]);
                  case 5 : 
                      ...
                      return /* SideEffects */Block.__(1, [(function (self) {
                                    var init = self[/* state */1][/* params */7];
                                    return Routes$Gayer.pushParamsState(undefined, /* record */[
                                                ...
                                                /* layers */changeLayer(oldLayer, maybeNewLayer, self[/* state */1][/* params */7][/* layers */14])
                                              ]);
                                  })]);
                  case 6 : 
                      var layers = action[0];
                  ...
                  case 7 : 
                      ...
                      newrecord$7[/* params */7] = params;
                      var init = state[/* drawContext */24];
                      newrecord$7[/* drawContext */24] = /* record */[
