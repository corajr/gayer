...
var component = ReasonReact.statelessComponent("JsonifySelect-Gayer");
  ...
  return /* record */[
          ...
          /* render */(function () {
              return ReasonReact.element(undefined, undefined, MaterialUi_Select.make(undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, (function ($$event, _) {
                                ...
                                return Curry._1(onChange, Curry._1(decoder, json));
                              }), undefined, undefined, undefined, undefined, undefined, /* `String */[
                              -976970511,
                              JSON.stringify(Curry._1(encoder, currentSetting))
                                      ...
                                      var s = JSON.stringify(Curry._1(encoder, setting));
